...
export class QueryBuilder {
   ...
   *
   * @param type - Type of join: 'INNER', 'LEFT', or 'RIGHT' (default: 'INNER')
   ...
   */
  private addInClause(keyword: 'WHERE' | 'AND' | 'OR' | 'HAVING', column: string, values: readonly SqlValue[]): this {
    if (values.length === 0) {
